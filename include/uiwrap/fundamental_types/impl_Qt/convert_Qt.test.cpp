...
{
    EXPECT_TRUE(too::almost_equal(2.45, from_qreal<double>(qreal{2.45})));
    ...
    EXPECT_TRUE(too::almost_equal(0.0, from_qreal<double>(qreal{0.0})));
...
{
    EXPECT_TRUE(too::almost_equal(qreal{2.45}, to_qreal(2.45)));
    ...
    EXPECT_TRUE(too::almost_equal(qreal{0.0}, to_qreal(0.0)));
